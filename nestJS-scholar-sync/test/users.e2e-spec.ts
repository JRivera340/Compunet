...
describe('Users E2E (CRUD /user)', () => {
    ...
    describe('POST /user', () => {
        ...
        it('should return 400 when required fields are missing', async () => {
            await request(app.getHttpServer()).post('/user').send({ email: 'incomplete@test.com' }).expect(400);
        });
    });
    ...
    describe('GET /user', () => {
        ...
        it('should also work with student token', async () => {
            await request(app.getHttpServer()).get('/user').set('Authorization', `Bearer ${studentToken}`).expect(200);
        });
    });
    ...
    describe('GET /user/:id', () => {
        ...
        it('should return 401 when no token provided', async () => {
            await request(app.getHttpServer()).get('/user/1').expect(401);
        });
    });
    ...
    describe('PATCH /user/:id', () => {
        ...
        it('should return 401 when no token provided', async () => {
            await request(app.getHttpServer()).patch('/user/1').send({ firstName: 'Noauth' }).expect(401);
        });
    });
