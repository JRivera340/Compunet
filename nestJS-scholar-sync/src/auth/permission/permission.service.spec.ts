...
describe('PermissionService', () => {
    ...
    describe('findAll', () => {
        it('should return an array of permissions', async () => {
            const permissions = [mockPermission, { ...mockPermission, id: 2, name: permissionRead }];
    ...
    describe('update', () => {
        ...
        it('should throw NotFoundException when permission does not exist', async () => {
            ...
            await expect(service.update(9999, { description: 'X' })).rejects.toThrow(NotFoundException);
        });
    });
