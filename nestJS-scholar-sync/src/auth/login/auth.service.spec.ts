...
const permissionCreate = 'Create users';
const permissionRead = 'Read users';
const permissionUpdate = 'Update users';
    ...
    usersRoles: [
        {
            ...
            role: {
                ...
                rolesPermissions: [
                    { id: 1, permission: { id: 1, name: permissionCreate } },
                    { id: 2, permission: { id: 2, name: permissionRead } },
                ],
            },
        },
    ],
...
describe('AuthService', () => {
    ...
    describe('login', () => {
        ...
        it('should deduplicate permissions when user has multiple roles with shared permissions', async () => {
                ...
                usersRoles: [
                    ...
                    },
                    {
                        ...
                        role: {
                            ...
                            name: RoleNames.TA,
                            rolesPermissions: [
                                { id: 3, permission: { id: 2, name: permissionRead } }, // duplicado
                                { id: 4, permission: { id: 3, name: permissionUpdate } },
                            ],
                        },
                    },
                ],
            ...
            expect(signCall.permissions).toEqual([permissionCreate, permissionRead, permissionUpdate]);
        ...
        it('should throw UnauthorizedException when password is incorrect', async () => {
            ...
            await expect(service.login({ email: 'dave@example.com', password: 'WrongPassword' })).rejects.toThrow(
