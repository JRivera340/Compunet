...
__decorate([
    (0, typeorm_1.ManyToOne)(() => role_entity_1.Role, (role) => role.rolesPermissions, { nullable: false, onDelete: 'CASCADE' }),
    (0, typeorm_1.JoinColumn)({ name: 'role_id' }),
    __metadata("design:type", role_entity_1.Role)
], RolePermission.prototype, "role", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => permission_entity_1.Permission, (permission) => permission.rolesPermissions, { nullable: false, onDelete: 'CASCADE' }),
...
exports.RolePermission = RolePermission = __decorate([
    (0, typeorm_1.Entity)('roles_permissions'),
    (0, typeorm_1.Unique)(['role', 'permission'])
], RolePermission);
